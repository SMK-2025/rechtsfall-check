...
export function Brand({ inverse=false }: { inverse?: boolean }){
  return <Link href="/" className="logo brand-logo" aria-label="Rechtsfall Check Startseite"><Image src={inverse?"/logo-rechtsfall-check-inverse.svg":"/logo-rechtsfall-check.svg"} alt="Rechtsfall Check" width={292} height={64} priority/></Link>
}
