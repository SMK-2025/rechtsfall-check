...
export default function AreasPage() {
  return <div className="site legal-areas-page"><SiteHeader/><main>
    ...
    <section className="areas-scope-band"><div className="section-wrap scope-note"><h2>Nicht sicher, welches Rechtsgebiet passt?</h2><p>Kein Problem. Wählen Sie „Anderes Thema / noch unsicher“ und schildern Sie den Fall in Ihren Worten. Bei akuten Fristen, laufenden Gerichtsverfahren, Haft, Durchsuchung oder anderen eilbedürftigen Situationen sollten Sie unmittelbar anwaltliche Hilfe einholen.</p><PublicSignupLink className="button">Kostenlose Fallakte anlegen →</PublicSignupLink></div></section>
