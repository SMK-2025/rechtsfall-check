...
export default function AreasPage() {
  return <div className="site"><SiteHeader/><main>
    ...
    <section className="scope-note section-wrap"><h2>Nicht sicher, welches Rechtsgebiet passt?</h2><p>Kein Problem. Wählen Sie „Anderes Thema / noch unsicher“ und schildern Sie den Fall in Ihren Worten. Bei akuten Fristen, laufenden Gerichtsverfahren, Haft, Durchsuchung oder anderen eilbedürftigen Situationen sollten Sie unmittelbar anwaltliche Hilfe einholen.</p><Link href="/anmelden?mode=signup" className="button">Rechtsfall Check starten →</Link></section>
