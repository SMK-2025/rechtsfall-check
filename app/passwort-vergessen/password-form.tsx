...
export function ForgotPasswordForm() {
  ...
  if(sent)return <div className="auth-notice" role="status"><strong>Bitte prüfe dein E-Mail-Postfach.</strong><br/>Wenn ein Konto zu dieser Adresse existiert, erhältst du in Kürze den Link zum Zurücksetzen.</div>;
