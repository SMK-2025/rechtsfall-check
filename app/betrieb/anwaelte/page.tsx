...
export default async function LawyerOperationsPage() {
  ...
  return <div className="member-shell"><MemberNavigation userName={admin.displayName} userEmail={admin.email} adminMode/>
    ...
    <style>{`.lawyer-operations-page{padding:clamp(2rem,4vw,4.5rem)}.lawyer-review-list{display:grid;gap:18px}.lawyer-review-card{padding:24px;border:1px solid #d7e2ea;border-radius:16px;background:#fff}.lawyer-review-summary{display:grid;grid-template-columns:1fr 1fr;gap:22px}.lawyer-review-summary h3{margin:4px 0;font-size:22px}.lawyer-review-summary p,.lawyer-review-meta{color:#607482;overflow-wrap:anywhere}.lawyer-review-summary small{font-weight:850;color:#397dcc}.lawyer-review-meta{display:flex;flex-wrap:wrap;gap:12px;margin:15px 0;padding:13px 0;border-top:1px solid #e2e9ee;border-bottom:1px solid #e2e9ee;font-size:12px}.lawyer-review-form{display:grid;grid-template-columns:1fr 1fr;gap:12px}.lawyer-review-form label{display:grid;gap:6px;font-size:12px;font-weight:750}.lawyer-review-form input,.lawyer-review-form textarea{min-width:0;width:100%;padding:11px;border:1px solid #cbd8e1;border-radius:9px;font:inherit}.lawyer-review-form .full{grid-column:1/-1}.lawyer-review-actions{display:flex;gap:10px}.lawyer-review-actions button{padding:11px 14px;border:0;border-radius:9px;background:#0b3048;color:#fff;font-weight:750}.lawyer-review-actions button+button{background:#e8eef3;color:#17384e}@media(max-width:700px){.lawyer-operations-page{padding:28px 20px 72px}.lawyer-operations-page>.member-heading{margin-bottom:26px}.lawyer-operations-page>.member-heading h1{font-size:clamp(34px,10vw,42px);line-height:1.08;overflow-wrap:anywhere}.lawyer-operations-page>.member-heading p{line-height:1.6}.lawyer-review-list{padding:22px 18px}.lawyer-review-list>header{align-items:flex-start}.lawyer-review-list>header>strong{font-size:1.35rem}.lawyer-review-summary,.lawyer-review-form{grid-template-columns:1fr}.lawyer-review-card{padding:19px 16px}.lawyer-review-actions{flex-direction:column}.lawyer-review-actions button{width:100%}}`}</style>
  </div>;
}
