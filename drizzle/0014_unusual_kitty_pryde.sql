...
CREATE INDEX "auth_two_factor_secret_idx" ON "twoFactor" USING btree ("secret");--> statement-breakpoint
CREATE INDEX "auth_two_factor_user_idx" ON "twoFactor" USING btree ("user_id");