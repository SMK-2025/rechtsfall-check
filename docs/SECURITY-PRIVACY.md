...
- **Löschjob-Prüfung:** Der geschützte Dry-Run zeigt ausschließlich fällige Anzahlen und verändert keine Daten. Produktive Läufe sind auf begrenzte Batches beschränkt; Einzelprobleme werden ohne Fallinhalte im Systemprotokoll sichtbar und im nächsten Lauf erneut versucht.
